...
public class ErrorHandlingMiddlewareTests
{
    ...
    public async Task InvokeAsync_WhenNoExceptionThrown_ShouldCallNextDelegate ()
    {
        ...
        var midleware = new ErrorHandlingMiddleware(loggerMock.Object);
        var context = new DefaultHttpContext();
        var nextDelegateMock = new Mock<RequestDelegate>();

        // Act
        await midleware.InvokeAsync(context, nextDelegateMock.Object);
    ...
    public async Task InvokeAsync_WhenNoFoundExceptionThrown_ShouldSetStatusCode404 ()
    {
        ...
        // Act
        await midleware.InvokeAsync(context, _ => throw notFoundException);
    ...
    public async Task InvokeAsync_WhenForbidExceptionThrown_ShouldSetStatusCode403 ()
    {
        ...
        // Act
        await midleware.InvokeAsync(context, _ => throw forbidException);
    ...
    public async Task InvokeAsync_WhenGenericExceptionThrown_ShouldSetStatusCode500 ()
    {
        ...
        // Act
        await midleware.InvokeAsync(context, _ => throw exception);
